...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x246c07;
...
const char     CRYPTONOTE_NAME[]                             = "Piso";
...
const int      P2P_DEFAULT_PORT                              = 11024;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 11048;
